...
export const pixelTheme: CustomThemeConfig  = {
	...
	properties: {
		...
		// primary | #4A46FF 
		"--color-primary-50": "228 227 255", // #e4e3ff
		"--color-primary-100": "219 218 255", // #dbdaff
		"--color-primary-200": "210 209 255", // #d2d1ff
		"--color-primary-300": "183 181 255", // #b7b5ff
		"--color-primary-400": "128 126 255", // #807eff
		"--color-primary-500": "74 70 255", // #4A46FF
		"--color-primary-600": "67 63 230", // #433fe6
		"--color-primary-700": "56 53 191", // #3835bf
		"--color-primary-800": "44 42 153", // #2c2a99
		"--color-primary-900": "36 34 125", // #24227d
